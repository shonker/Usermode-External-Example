...
float SkeletonColor[3] = { color.purple[0], color.purple[1], color.purple[2] };
float FOVColor[3] = { color.purple[0], color.purple[1], color.purple[2] };
float CorenrColor[3] = { color.purple[0], color.purple[1], color.purple[2] };
float BoxColor[3] = { color.purple[0], color.purple[1], color.purple[2] };
float ThreeDColor[3] = { color.purple[0], color.purple[1], color.purple[2] };
float SnaplineColor[3] = { color.purple[0], color.purple[1], color.purple[2] };
float textColor[3] = { color.purple[0], color.purple[1], color.purple[2] };